...
|is_vvol_backup
|boolean
a|Clone vvol for backup.


|nosplit_entry
|boolean
a|Mark clone to keep unsplit.
...
| 917812
| A relative path must be used for `destination_path` when a volume is specified.
...
| 13565998
| File clone using autodelete is not supported on a FlexGroup volume. Try the operation again without specifying the "autodelete" parameter.
|===
