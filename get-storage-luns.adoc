...
* link:storage_luns_endpoint_overview.html[DOC /storage/luns]
...
Attributes can be added/modified/removed for an existing LUN using the /api/storage/luns/{lun.uuid}/attributes endpoint. For further information, see link:storage_luns_lun.uuid_attributes_endpoint_overview.html[DOC /storage/luns/{lun.uuid}/attributes] .
...
|serial_number_hex
|string
a|The LUN serial number encoded in hexadecimal format. The serial number is generated by ONTAP when the LUN is created.
