...
| 10551885
| Package download failed due to invalid url.

| 10551892
| Package download failed due to an unhealthy node. Restore the node to a healthy state, then retry the operation.
