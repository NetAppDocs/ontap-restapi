...
* link:svm_peers_endpoint_overview.html[DOC /svm/peers]
...
|query
|False
a|Use this parameter to delete the SVM peer relationship even when the remote cluster is not accessible. For example, if there are network connectivity issues.
