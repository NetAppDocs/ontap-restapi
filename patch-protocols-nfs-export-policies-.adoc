...
* link:protocols_nfs_export-policies_endpoint_overview.html[DOC /protocols/nfs/export-policies]
...
|are_rules_truncated
|boolean
a|Indicates whether or not export-policy rules are truncated.
...
| 3277249
| Setting "allow-cache-async-writes" to "true" in export-policy rules requires an effective cluster version of 9.19.1 or later.
|===
