...
NIS configuration for the cluster is managed via link:security_authentication_cluster_nis_endpoint_overview.html[/api/security/authentication/cluster/nis] .
...
* link:name-services_nis_endpoint_overview.html[DOC /name-services/nis]
