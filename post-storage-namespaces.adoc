...
* link:storage_namespaces_endpoint_overview.html[DOC /storage/namespaces]
...
| 918235
| A volume with the specified UUID was not found.
...
| 5374184
| A namespace cannot be created because the SVM is part of a SnapMirror active sync NAS relationship.
...
| 5376756
| A vvol LUN cannot be transitioned to an NVMe namespace.
