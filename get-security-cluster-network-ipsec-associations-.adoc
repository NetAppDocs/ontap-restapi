...
summary: 'Retrieve an IPsec or IKE security association for the ONTAP cluster network'
---

= Retrieve an IPsec or IKE security association for the ONTAP cluster network

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/security/cluster-network/ipsec/associations/{uuid}`#

*Introduced In:* 9.19

Retrieves a specific IPsec or IKE (Internet Key Exchange) security association for cluster network.
