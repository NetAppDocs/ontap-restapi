...
* link:protocols_vscan_svm.uuid_on-demand-policies_endpoint_overview.html[DOC /protocols/vscan/{svm.uuid}/on-demand-policies]
...
| 10027173
| The new On-Demand policy cannot be created because the SVM has reached the maximum limit of 10 On-Demand policies. Delete an existing policy in order to create a new policy.
