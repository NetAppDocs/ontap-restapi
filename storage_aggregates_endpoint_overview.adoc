...
api: true
explorer: false
permalink: 'storage_aggregates_endpoint_overview.html'
...
Aggregates are automatically created and expanded in the ASA r2 system. Therefore, automatic and manual aggregate creation or expansion through REST is not supported.
