...
|is_svm_kek
|boolean
a|Indicates whether the keystore is SVM-KEK based.
...
| 65539857
| During the keystore switch operation, a restore operation failed.

| 65539858
| During the key migration operation, a restore operation failed.
