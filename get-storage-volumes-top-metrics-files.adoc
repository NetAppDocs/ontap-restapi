...
|total_throughput.write
|integer
|query
|False
a|Filter by total_throughput.write

* Introduced in: 9.19


|total_throughput.error.lower_bound
|integer
|query
|False
a|Filter by total_throughput.error.lower_bound

* Introduced in: 9.19


|total_throughput.error.upper_bound
|integer
|query
|False
a|Filter by total_throughput.error.upper_bound

* Introduced in: 9.19


|total_throughput.read
|integer
|query
|False
a|Filter by total_throughput.read
...
|query
|False
a|Filter by total_ops.read

* Introduced in: 9.19


|total_ops.error.lower_bound
|integer
|query
|False
a|Filter by total_ops.error.lower_bound

* Introduced in: 9.19


|total_ops.error.upper_bound
|integer
|query
|False
a|Filter by total_ops.error.upper_bound
...
|observation_window
|link:#observation_window[observation_window]
a|The time window over which metrics are aggregated.


|partial_response_reason
|link:#partial_response_reason[partial_response_reason]
a|Indicates that the metric report provides partial data.
...
[source,json,subs=+macros]
{
  ...
  "observation_window": {
    "duration": 60,
    "end": "2026-01-11 01:30:00 +0000",
    "start": "2026-01-11 01:29:55 +0000"
  },
  "partial_response_reason": {
    "code": "124518424",
...
| 124518423
| Volume activity tracking is not supported on the volume.
...
The time window over which metrics are aggregated.
...
|duration
|integer
a|Duration of the observation window in seconds.


|end
|string
a|End timestamp of the observation window in UTC.


|start
|string
a|Start timestamp of the observation window in UTC.
...
Indicates that the metric report provides partial data.
...
|read
|integer
a|Total read operations in the observation window.


|write
|integer
a|Total write operations in the observation window.
...
|read
|integer
a|Total bytes read in the observation window.


|write
|integer
a|Total bytes written in the observation window.
...
|total_ops
|link:#total_ops[total_ops]
a|

|total_throughput
|link:#total_throughput[total_throughput]
a|
