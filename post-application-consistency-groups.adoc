...
| 5376461
| The specified name is invalid because it does not match the format requirements.
...
| 53411856
| The provided field is only supported when provisioning new objects.
...
| 53412087
| Consistency group cannot be created because the SVM is part of a SnapMirror active sync NAS relationship.
|===
