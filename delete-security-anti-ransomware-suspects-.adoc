...
|query
|False
a|Specifies the file format of the suspect file.
...
| 203161673
| Operation is not supported on a data protection volume.

| 203162105
| Clearing a suspect by specifying the file format is not supported when an attack is detected by encryption_percentage_analysis.
|===
