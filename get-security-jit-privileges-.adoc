...
summary: 'Retrieve JIT privilege configurations for an SVM'
---

= Retrieve JIT privilege configurations for an SVM

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/security/jit-privileges/{owner.uuid}/{application}`#
