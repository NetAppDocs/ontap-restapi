...
api: true
explorer: false
permalink: 'get-security-jit-privileges.html'
summary: 'Retrieve global JIT privilege configurations for an SVM'
---

= Retrieve global JIT privilege configurations for an SVM

[.api-doc-operation .api-doc-operation-get]#GET# [.api-doc-code-block]#`/security/jit-privileges`#
...
|query
|False
a|Filter by max_jit_validity_period
...
|query
|False
a|Filter by default_session_validity_period
...
|records
|array[link:#security_jit_privilege[security_jit_privilege]]
a|
...
|owner
|link:#owner[owner]
a|Owner name and UUID that uniquely identifies the JIT privilege global settings.
