...
api: true
explorer: false
permalink: 'name-services_dns_endpoint_overview.html'
...
DNS configuration for the cluster is retrieved via link:cluster_endpoint_overview.html[/api/cluster] .
...
# The call:
curl -X GET "https://<mgmt-ip>/api/name-services/dns/179d3c85-7053-11e8-b9b8-005056b41bd1?fields=**" -H "accept: application/hal+json"
...
# The call:
    curl -X POST "https://<mgmt-ip>/api/name-services/dns?async=true" -H "accept: application/hal+json" -H "Content-Type: application/json" -d "{ \"svm\": { \"uuid\": \"179d3c85-7053-11e8-b9b8-005056b41bd1\" }, \"domains\": [ \"domainA.example.com\" ], \"servers\": [ \"10.10.10.10\" ]}"
----
...
# The call:
curl -X PATCH "https://<mgmt-ip>/api/name-services/dns/179d3c85-7053-11e8-b9b8-005056b41bd1?async=true" -H "accept: application/hal+json" -H "Content-Type: application/json" -d "{ \"servers\": [ \"10.10.10.10\" ]}"
----
