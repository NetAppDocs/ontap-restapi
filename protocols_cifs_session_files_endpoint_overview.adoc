...
api: true
explorer: false
permalink: 'protocols_cifs_session_files_endpoint_overview.html'
...
ONTAP `cifs sessions file show` functionality is used to provide a list of currently opened files.<h2/>
...
To retrieve the list of open files, use the following API. Note that _return_records=true_.
