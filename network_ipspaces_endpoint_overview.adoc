...
api: true
explorer: false
permalink: 'network_ipspaces_endpoint_overview.html'
...
# The call:
curl -X PATCH "https://<mgmt-ip>/api/network/ipspaces/4165655e-0528-11e9-bd68-005056bb046a" -H  "accept: application/hal+json" -d "{  \"tcp_stack\": \"rack\"}"
----
